...
from .views import view_bag, add_to_bag, adjust_bag, remove_bag
...
class TestBagViews(TestCase):
    ...
    def test_remove_from_bag(self):
        ...
        """
        link = reverse('remove_bag', args=['item_id'])
        self.assertEqual(resolve(link).func, remove_bag)
